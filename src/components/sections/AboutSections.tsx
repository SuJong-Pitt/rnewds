...
export function AboutHero() {
    return (
        <section className="relative min-h-[90vh] w-full flex flex-col items-center justify-center pt-40 pb-24 px-6 overflow-hidden bg-white">
            ...
            <div className="relative z-10 text-center max-w-6xl mx-auto space-y-12">
                ...
                <motion.h1
                    ...
                    className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-heading font-black leading-[1.05] tracking-tight text-slate-950"
                >
                    데이터로 기획하는 <br />
                ...
                <motion.p
                    ...
                    className="text-lg md:text-2xl text-slate-500 max-w-4xl mx-auto font-light leading-relaxed tracking-tight break-keep"
                >
...
export function PhilosophySection() {
    return (
        <section className="py-32 md:py-52 px-6 bg-white overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 md:gap-32 items-center">
                    ...
                    >
                        <div className="space-y-8">
                            ...
                            <h3 className="text-3xl md:text-6xl font-heading font-black text-slate-950 leading-[1.1] tracking-tight break-keep">
                                아름다움 이전에 <br />
                                <span className="text-blue-600 italic px-1">논리가 앞서야</span> 합니다.
                            </h3>
                            <p className="text-lg md:text-2xl text-slate-500 leading-relaxed font-light tracking-tight break-keep">
                    ...
                    >
                        <div className="absolute inset-0 bg-blue-600/5 rounded-[60px] blur-3xl -z-10 group-hover:bg-blue-600/10 transition-colors duration-1000"></div>
                        <div className="absolute -top-10 -right-10 w-full h-full border border-slate-100 rounded-[60px] -z-10 bg-slate-50 opacity-50"></div>
                        
                        <div className="w-full h-full rounded-[60px] relative overflow-hidden border border-slate-200 shadow-3xl shadow-slate-100 bg-white">
                            <Image 
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/60 via-transparent to-transparent flex flex-col justify-end p-12 md:p-16">
                                <motion.p 
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
                                    viewport={{ once: true }}
                                    transition={{ duration: 1, delay: 0.5 }}
                                    className="text-2xl md:text-4xl font-heading font-black text-white italic px-1 drop-shadow-2xl leading-tight"
                                >
...
export function ProcessSection() {
    ...
    return (
        <section className="relative py-32 md:py-52 px-6 bg-slate-950 text-white rounded-t-[60px] md:rounded-t-[100px] overflow-hidden">
            {/* Visual Texture */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 md:gap-32 items-center">
                    <div className="space-y-12">
                        <div className="space-y-8">
                            ...
                            <h3 className="text-3xl md:text-5xl lg:text-[4rem] font-heading font-black text-white leading-[1.05] tracking-tighter">
                                투명하고 <br /> <span className="text-blue-400 italic px-1">정밀한</span> 프로세스.
                            </h3>
                            <p className="text-lg md:text-2xl text-slate-400 leading-relaxed max-w-lg font-light tracking-tight break-keep">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-10">
                        {steps.map((step, i) => (
                            ...
                            >
                                <div className="bg-white/5 border border-white/10 p-10 md:p-12 rounded-[48px] hover:bg-white/10 transition-all duration-500 h-full flex flex-col justify-between shadow-sm group-hover:shadow-blue-500/10 group-hover:-translate-y-2">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-sm md:text-base text-slate-400 leading-relaxed font-light tracking-tight">{step.desc}</p>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
...
export function TrustSection() {
    return (
        <section className="relative py-32 md:py-52 px-6 text-center bg-slate-50 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 opacity-[0.03] select-none pointer-events-none flex items-center justify-center">
                <span className="text-[25vw] font-black text-slate-900 tracking-tighter leading-none italic">R:new</span>
            </div>
                ...
                <div className="max-w-6xl mx-auto space-y-20 md:space-y-32">
                    <div className="space-y-12">
                        ...
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
                            className="text-4xl md:text-6xl lg:text-[5rem] font-heading font-black text-slate-950 tracking-tighter leading-[1.05]"
                        >
                            디자인은 감각이 아니라, <br />
                        ...
                        <motion.p 
                            ...
                            className="text-lg md:text-2xl text-slate-500 font-light max-w-2xl mx-auto tracking-tight break-keep border-t border-slate-200 pt-10"
                        >
                    ...
                    <div className="flex flex-col items-center justify-center gap-10 md:gap-16 pt-10">
                        ...
                        >
                            ...
                            <div className="text-left space-y-2">
                                ...
                                <div className="text-2xl md:text-4xl font-black text-slate-950 tracking-tighter flex items-center gap-4 transition-transform group-hover:scale-[1.02] duration-500 select-all underline decoration-slate-100 underline-offset-8 decoration-4">
                                    mihail777@naver.com
                                </div>
                            </div>
